      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <button type="button" onClick={closeLevelUpModal}>
            <img src="/icons/close.svg" alt="Fechar" className={styles.closeButton} />
          </button>
